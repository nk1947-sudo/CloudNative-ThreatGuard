...
from runtime.engine.models import SecurityEvent, SecurityEventType, Severity
...
class TestResilienceAndFailureModes(unittest.TestCase):
    ...
    def test_out_of_order_events_chronological_sorting(self):
        ...
        incidents = self.engine.correlate_incidents(out_of_order)
    ...
    def test_duplicate_event_handling(self):
        ...
        incidents = self.engine.correlate_incidents([ev, ev, ev])
        self.assertEqual(len(incidents), 1)
