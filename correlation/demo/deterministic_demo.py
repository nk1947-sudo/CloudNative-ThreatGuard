...
from cloudgraphguard.models.findings import IAMFinding, FindingType, PrivilegeEscalationVector
from correlation.adapters.cgg_adapter import CloudGraphGuardAdapter
from correlation.adapters.tg_adapter import ThreatGuardAdapter
from correlation.models.mapping import IdentityBinding, IdentityMappingRegistry, MappingMechanism
from correlation.engine.correlation_engine import CrossDomainCorrelationEngine
from correlation.engine.risk_evaluator import CrossDomainRiskEvaluator
from correlation.models.incident import UnifiedIncidentManager
from correlation.graph.unified_graph import (
...
def build_demo_scenario() -> Dict[str, Any]:
    ...
    output_dir = os.path.join(PROJECT_ROOT, "artifacts", "forensics")
...
def run_deterministic_demo():
    ...
    print(f" Forensic audit evidence saved to: artifacts/forensics/cloud_security_demo_evidence.json")
    print("=" * 78)
